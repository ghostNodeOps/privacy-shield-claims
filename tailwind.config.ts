  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "safe-open": "safe-open 2s ease-in-out infinite alternate",
        "safe-close": "safe-close 2s ease-in-out infinite alternate",
        "encrypt": "encrypt 3s ease-in-out infinite",
        "decrypt": "decrypt 0.5s ease-out",
        "pulse-secure": "pulse-secure 2s infinite"
      },
    },
  },
